# Github repo to connect and push 

Quick setup — if you’ve done this kind of thing before
or	
https://github.com/CarloKva/Robin.dev.git
Get started by creating a new file or uploading an existing file. We recommend every repository include a README, LICENSE, and .gitignore.

…or create a new repository on the command line
echo "# Robin.dev" >> README.md
git init
git add README.md
git commit -m "first commit"
git branch -M main
git remote add origin https://github.com/CarloKva/Robin.dev.git
...
Deploy on this https://vercel.com/kva-projects
With the sdk of vercel

# Supabase config

Project name: Robin.dev
Database password: k&piJ%i$9xpyYU&
Project URL: https://ccgodxlviculeqsnlgse.supabase.co
anon key: eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImNjZ29keGx2aWN1bGVxc25sZ3NlIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzIxMDQwMTMsImV4cCI6MjA4NzY4MDAxM30.euA39HCEsWagx4SK_dJhWFRya7Wjc0AwjtJCCqQU0LM
service_role key: 
publishable key: sb_publishable_JgZbnylXbUO_hDka6nvKDA_Ja1DFUz5

Installation MCP supabase
Add the MCP server to your project config using the command line:

claude mcp add --scope project --transport http supabase "https://mcp.supabase.com/mcp?project_ref=ccgodxlviculeqsnlgse"
...
Alternatively, add this configuration to .mcp.json:
{
  "mcpServers": {
    "supabase": {
      "type": "http",
      "url": "https://mcp.supabase.com/mcp?project_ref=ccgodxlviculeqsnlgse"
    }
  }
}
...
```bash
# .env.local
NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY=pk_test_Z29vZC1zdGFnLTU1LmNsZXJrLmFjY291bnRzLmRldiQ
CLERK_SECRET_KEY=sk_test_FdTT6HX1CM6fe7nqUFPxTsdBqV7GkBQ3kr0qE57mmp
```
